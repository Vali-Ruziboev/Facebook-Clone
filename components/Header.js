        ...
        <div className="sticky top-0 z-50 bg-white flex items-center p-2 lg:px-5 shadow-md">
            ...
            <div className="flex items-center">
                ...
                <div className="flex ml-2 items-center rounded-full bg-gray-100 p-2 ">
                    ...
                    <input
                    className=" hidden
                    md:inline-flex ml-2 items-center bg-transparent outline-none  placeholder-gray-500 flex-shrink"
            ...
            <div className="flex items-center sm:space-x-7 justify-end">
                ...
                <p className="whitespace-nowrap font-semibold pr-3">Vali Ruziboev</p>
